...
# Default data paths.
DEFAULT_LABEL_FILE ='D://source/labels/2350-common-hangul.txt'
DEFAULT_FONTS_DIR ='D://source/fonts/'
DEFAULT_OUTPUT_DIR_IMAGE = 'D://source/image-data'
DEFAULT_OUTPUT_DIR_XML='D://source/xml'
...
for character in labels:
    ...
    for font in fonts:
        ...
        for i in range(DISTORTION_COUNT):
            ...
            xml_file_path = DEFAULT_OUTPUT_DIR_XML+xml_file_string
            f1 = open('D://source/frame.txt','r',encoding='utf8')
